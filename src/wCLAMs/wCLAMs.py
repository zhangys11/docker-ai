...
def analyze(csv, save_local = False):
    ...
    if save_local:
        ...
        # fn stores the local path

    return clams.analyze_file(csv)
...
def run_cla():
	...
	return render_template("home.html", use_sample = use_sample, d = d, nobs = n, cla_result = r)
...
if __name__ =='__main__':
    # Timer(1, open_browser).start(); # this will repeat multiple times
